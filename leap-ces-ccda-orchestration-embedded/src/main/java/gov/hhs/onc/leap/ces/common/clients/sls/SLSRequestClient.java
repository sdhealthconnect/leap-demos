...
package gov.hhs.onc.leap.ces.common.clients.sls;
...
public class SLSRequestClient {
    private final static Logger LOGGER = Logger.getLogger(gov.hhs.onc.leap.ces.common.clients.sls.SLSRequestClient.class.getName());
    ...
    public String requestLabelingSecured(String id, String origin, String msgSource, String msgVersion, String msg) throws IOException {
        String result = "";
